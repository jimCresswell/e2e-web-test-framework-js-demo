...
exports.config = {
  ...
  cucumberOpts: {
    require: ['./step_definitions/**/*.steps.js'], // <string[]> (file/dir) require files before executing features
  ...
  * @param  {[type]} sourceLocation [description]
  */
  afterScenario: function afterScenario(uri, feature, scenario) {
    ...
    if (scenario.tags && scenario.tags.some((tag) => tag.name === '@cleanState')) {
